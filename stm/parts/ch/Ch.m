...
methods
    ...
    function obj=parse_Opts(obj,Opts,ptb)
        ...
        names={...
            ...
            'retLength',4,'isnumeric'; ... % XXX
            'retWidth',.15,'isnumeric'; ...
...
%% points
    ...
    function obj=get_outer_cardinals_points(obj)
        [obj.oU,obj.oD,obj.oL,obj.oR]=cardinals(obj.posXY(1),obj.posXY(2),obj.outRadius(1),obj.outRadius(2));
    end
